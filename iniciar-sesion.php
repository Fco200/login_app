    ...
    if (!verificar_csrf() || !empty($_POST['empresa'])) {
        ...
        if ($email === '' || $password === '') {
            ...
            if (!$usuario || !password_verify($password, $usuario['password'])) {
                ...
                login_ok($usuario);
                if (esta_admin()) {
                    header('Location: ' . url_sitio('admin/index.php'));
                } else {
...
<head>
    ...
    <title>Iniciar sesión — <?= e(SITE_NOMBRE) ?></title>
    ...
    <div class="d-flex flex-column align-items-center w-100">
        ...
        <div class="card card-gral shadow-lg w-100">
            <div class="card-body p-4 p-md-5">
                ...
                <p class="text-muted small mb-4">Accede a tu cuenta para dar seguimiento a tus cotizaciones y personalizar tu experiencia.</p>
                ...
                <form method="POST" action="iniciar-sesion.php" novalidate>
                    <?= campo_csrf() ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="text-end mt-2">
                            <a href="recuperar-password" class="small fw-semibold" style="color:#0a3d8f;">¿Olvidaste tu contraseña?</a>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-fv w-100 py-2"><i class="bi bi-box-arrow-in-right me-1"></i>Entrar a mi cuenta</button>
                </form>
        ...
        <div class="aside-info text-center mt-4 px-3 py-3 rounded text-white-50 small" style="background:rgba(255,255,255,.08);">
            <i class="bi bi-shield-check me-1"></i>
            <span>Al iniciar sesión podrás: seguir el estado de tus solicitudes, bajas de servicios, administrar tu suscripción al boletín y actualizar tu información.</span>
        </div>
